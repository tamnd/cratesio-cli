...
Most of these come down to network reality or how cratesio serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

cratesio rate-limits like any public site. crates already paces
...
Where a surface is gated, crates reads a cookie or token you supply
...
`crates`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what crates actually did
